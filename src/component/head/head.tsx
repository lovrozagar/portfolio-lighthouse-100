const Head = () => {
	return (
		<head>
			...
			<meta
				name='keywords'
				content='Lovro Žagar, Senior Software Engineer, Next.js, React, TypeScript, Frontend Engineer, Web Developer, scalable web applications, clean code, performance optimization'
			/>
			<meta name='author' content='Lovro Žagar' />
			<meta name='viewport' content='width=device-width, initial-scale=1.0' />
			<meta property='og:title' content='Lovro Žagar - Senior Software Engineer' />
			<meta
